angular.module('lockerClient.services', ['ngResource', 'ionic'])
...
.factory('LockerService', function($q, $resource, $http) {
	var host = 'http://180.183.53.197:8080';
	...
	return {
		...
		getIsUserHasReserved: function() {
			return $http.get(host + '/user/is_reserved');
		},
